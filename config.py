...
# could be overwritten by command line argument
_C.MODEL.PRETRAINED = ''
_C.MODEL.RESNET_PRETRAINED = '/home/pl/htt/swin-transformer-or/weights/resnet50-19c8e357.pth'
...
#SwinNet
_C.MODEL.SWINNET = CN()
_C.MODEL.SWINNET.PATCH_SIZE = 4
_C.MODEL.SWINNET.IN_CHANS = 3
_C.MODEL.SWINNET.EMBED_DIM = 96
_C.MODEL.SWINNET.DEPTHS = [2, 2, 6, 2]
_C.MODEL.SWINNET.NUM_HEADS = [3, 6, 12, 24]
_C.MODEL.SWINNET.WINDOW_SIZE = 7
_C.MODEL.SWINNET.WINDOW_SIZE = 7
_C.MODEL.SWINNET.MLP_RATIO = 4.
_C.MODEL.SWINNET.QKV_BIAS = True
_C.MODEL.SWINNET.QK_SCALE = None
_C.MODEL.SWINNET.APE = False
_C.MODEL.SWINNET.PATCH_NORM = True
